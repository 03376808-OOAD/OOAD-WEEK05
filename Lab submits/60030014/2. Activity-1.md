...
![activity1](imgs/activity1-1.PNG)
โปรแกรมยังไม่สมบูรณ์ ยังเรียกใช้งานคลาสไม่ถูกต้อง
...
รัน บันทึก และอธิบายผลการทำงานของโปรแกรม
![ผลการทดลอง](imgs/activity1-2.PNG)
***
...
![แบบฝึกหัด](imgs/activity1-3.PNG)
