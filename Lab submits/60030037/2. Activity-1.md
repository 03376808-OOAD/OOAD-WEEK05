...
รัน บันทึก และอธิบายผลการทำงานของโปรแกรม
![catEatMeow](imgs/cat-Eat-Meow.PNG)
```
โปรแกรมเรียกใช้งานเมธอด Eat ของ Class Animal ซึ่งเป็น Base Class ของ Class Cat และเรียกใช้งานเมธอด Meow ของ Class Cat แต่เนื่องจากไม่มีคำสั่งใด ๆ ในเมธอดดังกล่าวทั้งคู่ หน้าจอ Console จึงไม่มีตัวอักษรใด ๆ แสดงผล
```
...
รัน บันทึก และอธิบายผลการทำงานของโปรแกรม
![puppyEatBarkWeep](imgs/puppy-Eat-Bark-Weep.PNG)
```
โปรแกรมเรียกใช้งานเมธอด Eat ของ Class Animal ซึ่งเป็น Base Class ของ Class Dog ซึ่งเป็น Base Class ของ Class Puppy อีกทีหนึ่ง แต่เนื่องจากในเมธอด Eat ดังกล่าวไม่มีการเรียกใช้คำสั่งใด ๆ จึงไม่มีการแสดงผล หลังจากนั้นจึงเรียกใช้เมธอด Bark ของ Class Dog ซึ่งเป็น Base Class ของ Class Puppy และแสดงผลข้อความว่า "dog big barking..." สุดท้ายจึงเรียกใช้เมธอด Weep ของ Class Puppy และแสดงผลข้อความว่า "weeping..."
```
