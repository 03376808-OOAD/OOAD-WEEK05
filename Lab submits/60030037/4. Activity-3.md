...
```
    ในการสร้าง Object ของ Child ขึ้นมาชื่อว่า child นั้น Constructor ของ Parent ซึ่งรับ Parameter เป็น string 1 ตัว จะถูกเรียกใช้ก่อนอันเนื่องมาจากการระบุ Constructor ของ Child เป็น public Child():base("From Derived"){} จากนั้น Constructor ของ Child จะถูกเรียกใช้ต่อไป
    
    เมื่อเรียกใช้ method print ของ child แล้ว method print ของ Parent จะถูกเรียกก่อน จากคำสั่ง base.print(); ตามด้วย method WriteLine ของ Console ส่งข้อความออกหน้าจอเป็น "I'm a Child Class."

    เมื่อเรียกใช้ ((Parent)child).print(); แล้ว method print ของ Parent ซึ่งเป็นพ่อแม่ของ child จะถูกเรียกใช้ ได้ข้อความออกมาเป็น "I'm a Parent Class"
```