...
จากโปรแกรมใน main จะเขียนไว้ว่าให้แสดงผลตาม สแตก ที่ได้ถูกกำหนดไว้ว่าเริ่มแสดงผลจาก dObj[0]-dObj[4]โดยจะแสดงผลเรียงตามลำดับ แล้วก็จะถูกเรียนตามโปรแกรมที่เขียนไว้ตามลำดับ dObj[0]ก็จะไปถูกเรียนไป Line ที่ถูกเขียนให้สืบทอดมาจาก DrawingObject แล้วให้แสดงผลว่าI'm a Line ทุกอันก็จะถูกเขียนไว้ตามนี้ โดยทุกobjectคือ Line Square Circle จะถูกเขียนให้สืบทอดจาก DrawingObjectทั้งหมด 
---
...
การแสดงผลก็คล้านข้อด้านบนแต่ที่เพิ่มมาคือ class Rectangle ซึ่งจะถูกเขียนให้สืบทอดมาจาก Square และSquare ไปสืบทอดจาก DrawingObjectอีกทีหนึ่ง และให้แสดงผลคือI'm a rectangle.
...
เมื่อเปลี่ยนจากoverride เป็น new จะถูกเปลี่ยนที่มาของการแสดงผล overrideจะเป็นการแสดงของตัวมันเอง แต่ถ้าเป็น newจะถูกให้แสดงตัวที่มันสืบทอดมา