...
class parent จะถูกเรียกใช้งานก่อนแล้วต่อมาจะแสดงผล class Child แล้วแสดงผลตามที่ใส่ค่าไว้คือ I'm Parent Class

1.5.3 ความสามารถ (เมธอด) อะไรบ้างที่ ChildClass ได้รับสืบทอดมาจาก ParentClass โดยที่ไม่ค้องเขียน code เอง

สืบทอดการแสดงผลจาก class parent คือ Parent Constructor และ I'm a Parent Class คือการแสดงผลทั้ง2ที่class Child สืบทอดมาจาก class Parent
...
เรียก print จาก class child ถึง คุณสมบัติที่childสืบทอดมาจากparent แล้วแสดงผลเป็นข้อความ โปรแกรมจะแสดงผล จาก Childก่อนคือ I'm a Child Constructor. และ แสดงจากที่สืบทอดมาต่อคือ I'm a parent class.
