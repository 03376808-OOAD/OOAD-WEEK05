...
animal สร้างคลาสมาจากคลาส Animal ทำให้สามารถเรียกใช้ความสามารถของ Animal ได้เมื่อเรียกใช้การกินจะเห็นว่าการแสดงผลไม่ขึ้นอะไรเนื่องจากในตัวการกินไม่ได้เขียนไว้ให้โชว์อะไรขึ้นมา
...
Cat ได้ทำการสืบทอดมาจาก Animal ทำให้ cat ที่สร้างจาก Cat มีความสามารถของ Animal ด้วย

![img](im/img3.PNG)

(ได้ใส่ความสามารถในการกินและการร้องเหมียวใ้หมีการแสดงผล)
...
Puppy ได้ทำการสืบทอดมาจาก Dog และ Dog สืบทอดมาจาก Animal ทำให้ puppy ที่ถูกสร้างมาจาก class Puppy สามารถเรียกใช้ความสามารถได้ทั้งของ Animal Dog และ Puppy
