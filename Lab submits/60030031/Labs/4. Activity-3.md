...
โปรแกรมสามารถทำงานได้ โดยchild ถูกสร้างมาจาก class ChildClass ซึ่ง ChildClass เป็นตัวลูกของ ParentClass ทำให้ดึงตัวเมธอดของParentClassด้วย ซึ่งมันเรียกตัว constructor มาก่อนแล้วเรียกเมดธอดตัวเองตามด้วยเมดธอดของคลาสแม่โดยเมดธอดที่ได้มาจากคลาสแม่คือตัว Parent Constructor. และ I'm a Parent Class.
...
โปรแกรมามารถทำงานได้ โดยchild.print(); จะสั่งปริ้นเมดธอดในคลาสลูก ซึ่ง constructor ของ base class ที่รับ string  จำนวน 1 ตัว จะทำงาน ซึ่งต่อมาก็จะทำในส่วนของคลาสแม่และคลาสตัวเองตามลำดับ ซึ่งในคำสั่ง ((Parent)child).print(); เป็นการสั่ง print ตัว Parent ของคลาสลูกซึ่งจะได้ I'm a Parent Class.