...
ส้ร้างวัตถุ dog จากคลาส Dog ที่สืบทอดคุณสมบัติจากคลาส Animal และวัตถุ puppy จากคลาส Puppy ที่สืบทอดคุณสมบัติจากคลาส Dog 
และเรียกใช้ฟังก์ชั่น dog.Bark() และ puppy.Bark() 
หมายเหตุ ที่ฟังก์ชั่น puppy.Bark() ไม่แสดง ข้อความของฟังก์ชั่น Bark() จากคลาส Dog เพราะได้ถูกซ่อนเอาไว้เมื่อใช้คำสั่ง new ในตอนสร้างฟังก์ชั่น
Bark() ในคลาส Puppy
***
